document.addEventListener("DOMContentLoaded", () => {
    ...
    if (majorName) {
        ...
        Promise.all([
            ...
            .then(([cbmajorsData, apClassesData]) => {
            //.then(([cbmajorsData, aimajorsData, apClassesData]) => {
                ...
                document.getElementById("hero-desc").innerHTML = `The College Board suggests <strong>${cbCourseCount} AP courses</strong>, and AI recommends <strong>XX AP courses</strong> as useful for this major. However, this doesn't mean you need to take these courses or exams to pursue this major.`;
    ...
    function populateCourses(containerId, selectedmajor, apClassesData, toggleClass) {
        ...
        selectedmajor.ap_courses.forEach((apCourseName) => {
            ...
            if (apCourse) {
                ...
                majorScoreBeadSpan2.textContent = `M%:${majorScore}`;
    ...
    function attachToggleEvents() {
        ...
        console.log("CB Course Entries:", cbCourseEntries); // Debugging log
        ...
        cbCourseEntries.forEach((courseEntry) => {
            ...
            if (toggleLink) {
                toggleLink.addEventListener("click", (event) => {
                    ...
                    console.log("Toggle clicked for CB:", courseEntry); // Debugging log
        ...
        console.log("AI Course Entries:", aiCourseEntries); // Debugging log
        ...
        aiCourseEntries.forEach((courseEntry) => {
            ...
            if (toggleLink) {
                toggleLink.addEventListener("click", (event) => {
                    event.preventDefault();
                    console.log("Toggle clicked for AI:", courseEntry); // Debugging log
                    courseDetails.classList.toggle("show-details");
